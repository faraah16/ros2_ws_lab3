...
#include "fleet_interfaces/srv/detail/assign_task__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // required_capabilities, robot_id, task_id, task_type
#include "rosidl_runtime_c/string_functions.h"  // required_capabilities, robot_id, task_id, task_type
...
using _AssignTask_Request__ros_msg_type = fleet_interfaces__srv__AssignTask_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: required_capabilities
  {
    size_t size = ros_message->required_capabilities.size;
    auto array_ptr = ros_message->required_capabilities.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: required_capabilities
  {
    ...
    if (ros_message->required_capabilities.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->required_capabilities);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->required_capabilities, size)) {
      fprintf(stderr, "failed to create array for field 'required_capabilities'");
      return false;
    }
    auto array_ptr = ros_message->required_capabilities.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'required_capabilities'\n");
        return false;
      }
    }
  }
...
static uint32_t _AssignTask_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fleet_interfaces__srv__AssignTask_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_interfaces__srv__AssignTask_Request;
    is_plain =
      (
...
static size_t _AssignTask_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fleet_interfaces__srv__AssignTask_Request(
...
// already included above
// #include "rosidl_runtime_c/string.h"  // assigned_robot_id, message
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // assigned_robot_id, message

// forward declare type support functions


using _AssignTask_Response__ros_msg_type = fleet_interfaces__srv__AssignTask_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fleet_interfaces__srv__AssignTask_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fleet_interfaces__srv__AssignTask_Response;
    is_plain =
      (
...
static size_t _AssignTask_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fleet_interfaces__srv__AssignTask_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "fleet_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "fleet_interfaces/srv/assign_task.h"
