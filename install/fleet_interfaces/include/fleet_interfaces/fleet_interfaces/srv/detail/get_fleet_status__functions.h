...
#ifndef FLEET_INTERFACES__SRV__DETAIL__GET_FLEET_STATUS__FUNCTIONS_H_
#define FLEET_INTERFACES__SRV__DETAIL__GET_FLEET_STATUS__FUNCTIONS_H_
...
#include "fleet_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "fleet_interfaces/srv/detail/get_fleet_status__struct.h"

/// Initialize srv/GetFleetStatus message.
/**
...
/// Finalize srv/GetFleetStatus message.
/**
...
/// Create srv/GetFleetStatus message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fleet_interfaces__srv__GetFleetStatus_Request__init().
...
/// Destroy srv/GetFleetStatus message.
/**
 * It calls
 * fleet_interfaces__srv__GetFleetStatus_Request__fini()
...
/// Check for srv/GetFleetStatus message equality.
/**
...
/// Copy a srv/GetFleetStatus message.
/**
...
/// Initialize array of srv/GetFleetStatus messages.
/**
...
/// Finalize array of srv/GetFleetStatus messages.
/**
 * It calls
 * fleet_interfaces__srv__GetFleetStatus_Request__fini()
...
/// Create array of srv/GetFleetStatus messages.
/**
 * It allocates the memory for the array and calls
 * fleet_interfaces__srv__GetFleetStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetFleetStatus messages.
/**
 * It calls
 * fleet_interfaces__srv__GetFleetStatus_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetFleetStatus message array equality.
/**
...
/// Copy an array of srv/GetFleetStatus messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fleet_interfaces__srv__GetFleetStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fleet_interfaces
...
/**
 * It calls
 * fleet_interfaces__srv__GetFleetStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_fleet_interfaces
...
/**
 * It allocates the memory for the array and calls
 * fleet_interfaces__srv__GetFleetStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fleet_interfaces
...
/**
 * It calls
 * fleet_interfaces__srv__GetFleetStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FLEET_INTERFACES__SRV__DETAIL__GET_FLEET_STATUS__FUNCTIONS_H_
