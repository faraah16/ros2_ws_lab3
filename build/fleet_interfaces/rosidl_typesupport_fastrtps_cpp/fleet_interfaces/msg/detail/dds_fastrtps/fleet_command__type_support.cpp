...
#include "fleet_interfaces/msg/detail/fleet_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fleet_interfaces::msg::FleetCommand & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.target_robot_ids;
  }
  ...
  cdr << ros_message.task_description;
  // Member: priority
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fleet_interfaces::msg::FleetCommand & ros_message)
{
  // Member: command_id
  cdr >> ros_message.command_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: target_robot_ids
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.target_robot_ids[index].size() + 1);
    }
  }
  // Member: robot_type_filter
  current_alignment += padding +
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fleet_interfaces
max_serialized_size_FleetCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_interfaces::msg::FleetCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fleet_interfaces::msg::FleetCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleet_interfaces::msg::FleetCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FleetCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fleet_interfaces::msg::FleetCommand *>(
...
static size_t _FleetCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FleetCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FleetCommand__callbacks = {
...
static rosidl_message_type_support_t _FleetCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FleetCommand__callbacks,
...
{
  return &fleet_interfaces::msg::typesupport_fastrtps_cpp::_FleetCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fleet_interfaces, msg, FleetCommand)() {
  return &fleet_interfaces::msg::typesupport_fastrtps_cpp::_FleetCommand__handle;
}
