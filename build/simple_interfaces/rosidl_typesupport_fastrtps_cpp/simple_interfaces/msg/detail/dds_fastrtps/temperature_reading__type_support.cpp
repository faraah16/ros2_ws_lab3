...
#include "simple_interfaces/msg/detail/temperature_reading__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simple_interfaces::msg::TemperatureReading;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simple_interfaces::msg::TemperatureReading *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simple_interfaces::msg::TemperatureReading *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TemperatureReading__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const simple_interfaces::msg::TemperatureReading *>(
...
static size_t _TemperatureReading__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TemperatureReading(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TemperatureReading__callbacks = {
...
static rosidl_message_type_support_t _TemperatureReading__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TemperatureReading__callbacks,
...
{
  return &simple_interfaces::msg::typesupport_fastrtps_cpp::_TemperatureReading__handle;
}
