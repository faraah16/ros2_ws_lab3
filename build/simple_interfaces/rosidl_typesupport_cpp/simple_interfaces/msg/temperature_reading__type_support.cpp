...
static const _TemperatureReading_type_support_symbol_names_t _TemperatureReading_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, msg, TemperatureReading)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_interfaces, msg, TemperatureReading)),
  }
};
...
{
  return &::simple_interfaces::msg::rosidl_typesupport_cpp::TemperatureReading_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_interfaces, msg, TemperatureReading)() {
  return get_message_type_support_handle<simple_interfaces::msg::TemperatureReading>();
}
