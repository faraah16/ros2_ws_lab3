...
#include "fleet_interfaces/srv/detail/assign_task__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.required_capabilities;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: required_capabilities
  {
    size_t array_size = ros_message.required_capabilities.size();
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.required_capabilities[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_interfaces::srv::AssignTask_Request;
    is_plain =
      (
      offsetof(DataType, required_capabilities) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const fleet_interfaces::srv::AssignTask_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleet_interfaces::srv::AssignTask_Request *>(
    untyped_ros_message);
...
{
  return &fleet_interfaces::srv::typesupport_fastrtps_cpp::_AssignTask_Request__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.estimated_completion_time;
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: estimated_completion_time
  {
    size_t item_size = sizeof(ros_message.estimated_completion_time);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fleet_interfaces::srv::AssignTask_Response;
    is_plain =
      (
      offsetof(DataType, estimated_completion_time) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const fleet_interfaces::srv::AssignTask_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fleet_interfaces::srv::AssignTask_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &fleet_interfaces::srv::typesupport_fastrtps_cpp::_AssignTask_Response__handle;
}
...
{
  return &fleet_interfaces::srv::typesupport_fastrtps_cpp::_AssignTask__handle;
}
