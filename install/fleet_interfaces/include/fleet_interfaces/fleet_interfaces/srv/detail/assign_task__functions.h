...
#ifndef FLEET_INTERFACES__SRV__DETAIL__ASSIGN_TASK__FUNCTIONS_H_
#define FLEET_INTERFACES__SRV__DETAIL__ASSIGN_TASK__FUNCTIONS_H_
 ...
 * calls
 * fleet_interfaces__srv__AssignTask_Request__init().
...
/**
 * It calls
 * fleet_interfaces__srv__AssignTask_Request__fini()
 ...
 * fleet_interfaces__srv__AssignTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * fleet_interfaces__srv__AssignTask_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fleet_interfaces__srv__AssignTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fleet_interfaces
...
/**
 * It calls
 * fleet_interfaces__srv__AssignTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_fleet_interfaces
...
/**
 * It allocates the memory for the array and calls
 * fleet_interfaces__srv__AssignTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fleet_interfaces
...
/**
 * It calls
 * fleet_interfaces__srv__AssignTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FLEET_INTERFACES__SRV__DETAIL__ASSIGN_TASK__FUNCTIONS_H_
