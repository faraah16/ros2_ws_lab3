...
bool fleet_interfaces__srv__assign_task__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fleet_interfaces.srv._assign_task.AssignTask_Request", full_classname_dest, 52) == 0);
  }
  fleet_interfaces__srv__AssignTask_Request * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // required_capabilities
    PyObject * field = PyObject_GetAttrString(_pymsg, "required_capabilities");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'required_capabilities'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      if (!rosidl_runtime_c__String__Sequence__init(&(ros_message->required_capabilities), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
      rosidl_runtime_c__String * dest = ros_message->required_capabilities.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * fleet_interfaces__srv__assign_task__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fleet_interfaces.srv._assign_task");
  ...
  {  // required_capabilities
    PyObject * field = NULL;
    size_t size = ros_message->required_capabilities.size;
    rosidl_runtime_c__String * src = ros_message->required_capabilities.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "required_capabilities", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool fleet_interfaces__srv__assign_task__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fleet_interfaces.srv._assign_task.AssignTask_Response", full_classname_dest, 53) == 0);
  }
  fleet_interfaces__srv__AssignTask_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // estimated_completion_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "estimated_completion_time");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->estimated_completion_time = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * fleet_interfaces__srv__assign_task__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // estimated_completion_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->estimated_completion_time);
    {
      int rc = PyObject_SetAttrString(_pymessage, "estimated_completion_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
